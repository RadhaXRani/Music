...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7763435852").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/HAPPY_BOTS_CHANNEL"
)  # Example:- https://t.me/Dns_Official_Channel
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/HAPPY_BOTS_SUPPORT"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/HAPPY_BOTS_CHANNEL")
